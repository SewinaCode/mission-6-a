...
export default function FeatureSpec(features) {
  return (
    <div className="p-features">
      <FeatureIcon image={cpu} name="Processor" spec="Intel Core i7" />
      <FeatureIcon image={null} name="OS" spec="Windows 11 Pro" />
      <FeatureIcon image={ssd} name="SSD" spec="1tb" />
      <FeatureIcon image={ram} name="DDR-4" spec="124gb" />
      <FeatureIcon image={screenres} name='15.6"' spec="inch" />
    </div>
  );
}
